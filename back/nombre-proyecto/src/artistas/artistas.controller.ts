import { Controller, Get, Post, Body, Param, Patch, Delete, UploadedFile, UseInterceptors, BadRequestException, NotFoundException } from '@nestjs/common';
...
export class ArtistasController {
    ...
    async update(@Param('id') id: number, @Body() updateArtistaDto: UpdateArtistaDto, @UploadedFile() file?: Express.Multer.File): Promise<Artista> {
        if (file) {
